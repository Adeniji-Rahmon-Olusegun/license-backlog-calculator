const { checkOldOrNew, oddOREven, calculateYearDifference, newFeesA, heuristicsA} = require('./utilityFuncs');

function calculateFeeA(currentYear, expiryDate, totalCapacity, takeOverFee) {
    let resOld = 0;
    let resNew = 0;
    let totalRes = 0;
    ...
    if (oddOREven(newYears)) {
        ...
        let newFee = newFeesA(totalCapacity)
